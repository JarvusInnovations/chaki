...
module.exports = {
    ...
    _installPackages : function (opts) {
        ...
        data.workspacePackagesPath = this.App._getWorkspacePackagesPath(cmdProperties) || "packages";
        ...
        data.packages.forEach(function (packageName) {
            ...
            console.log('[install] 2.1', packageName);
    ...
    _installPackage : function (opts, fn) {
        ...
        var err,
            packagePath = opts.workspacePackagesPath + '/' + opts.packageName;
    ...
    _tracePackageDependencies : function (opts, fn) {
        ...
        if (fs.existsSync(opts.packagePath + '/app.json')) {
            ...
            if (appProperties && appProperties.requires && appProperties.requires.length > 0) {
                console.log('[install 5.2]');
                this._installPackages({path : opts.packagePath, method : opts.method});
            }
        }
    },

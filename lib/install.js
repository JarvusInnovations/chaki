...
module.exports = {
            ...
            that._installPackage(data, function (err, path) {
                if (!err) {
                    ...
                    that._tracePackageDependencies({
                        ...
                        trace : data.trace,
                        children : opts.children || data.appConfig.requires
                    });
                } else {
                    console.error(err);
                }
    ...
    _getPackageInstallPath : function (opts) {
        console.log('[Install] get package install path 1', opts);
        ...
        console.log('[Install] get package install path 2', packagePath);
        return packagePath;
    },
    ...
    _tracePackageDependencies : function (opts) {
        ...
        if (opts.children.length > 0) {
            ...
            opts.children.pop(opts.packageName);
        } else {
            trace = [];
        }
